...
`v4.8`
|
 Real-time bidirectional messaging & presence 
|
|
**
MongoDB + Mongoose
...
**
|
 Stateless authentication via HTTP-only cookies 
|
|
**
bcryptjs
...
**
|
 Cloud storage for images & profile pictures 
|
|
**
Resend
**
|
 Transactional email (welcome emails) 
|
|
**
Arcjet
**
|
 Bot detection, rate limiting, OWASP shield 
|
|
**
cookie-parser
...
|
**
TailwindCSS v3 + DaisyUI
**
|
 Utility-first styling & component library 
|
|
**
Lucide React
...
**
|
 JWT verified on every WebSocket handshake 
|
|
**
Bot Detection
...
**
|
 Server-side email regex & password length checks 
|
---
## 📸 Screenshots
